...
| `uiautomator-cli` base + engineering | 1-22 done, 23-25 open | Non-blocking |
| `bugfix` selector fixes | Done (1-3) | Satisfied |
| `phase2` enhancements | partial (2/3/4 done, others open) | Non-blocking by default |
...
### 6.1 Release Engineering (Post-Release Priority)

From `uiautomator-cli/tasks.md`:

1. Task 23: multi-arch/multi-version regression matrix
- Status: Open
- Priority: High
- Blocking: Post-Release

2. Task 24: post-install smoke (`cargo install` path)
- Status: Open
- Priority: High
- Blocking: Post-Release

3. Task 25: nightly regression guardrail
- Status: Open
- Priority: Medium-High
- Blocking: Post-Release

### 6.2 Phase2 Enhancements
...
1. Task 24 (`cargo install` smoke)
2. Task 23 (regression matrix)

### P1

1. Task 25 (nightly guardrail)
2. Phase2 Task 1.2/1.3 (error chain consolidation)

### P2

1. Phase2 Task 5 (API consistency)
2. Phase2 Task 6 (mock systematization)
3. Phase2 Task 7 (optional cache/perf)
