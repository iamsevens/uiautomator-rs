...
Write-Host "Downloading UiAutomator APK assets (version $UiAutomatorVersion) ..." -ForegroundColor Green
Download-FileIfMissing -FileName "app-uiautomator.apk" -Url "https://github.com/openatx/android-uiautomator-server/releases/download/$UiAutomatorVersion/app-uiautomator.apk"
Download-FileIfMissing -FileName "app-uiautomator-test.apk" -Url "https://github.com/openatx/android-uiautomator-server/releases/download/$UiAutomatorVersion/app-uiautomator-test.apk"
